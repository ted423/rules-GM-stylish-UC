...
(function () {
  function init(e) {
    ...
    .sej_container{\
      ...
      font-family: Comic Sans MS,"Microsoft JhengHei","Microsoft YaHei",微软雅黑;\
      display:table;\
      position: relative;\
      z-index: auto;\
    ...
    var siteInfos = [
    {
      name: "google",
      enabled: true,
      url: /^https?:\/\/www\.google(?:\.[A-z]{2,3}){1,2}\/(?!cse\?)(?!.*\/)(?!.*preferences\?)(?!.*cse\/)(?!.*tbm=isch)(?!.*tbs=sbi)/,
      engineList: 'web',
      style: '\
      position: fixed;\
      left: 10px;\
    ...
    {
      name: "baidu网页搜索",
      url: /^https?:\/\/(www|news)\.baidu\.com(?!\/fav)(?!\/search\/)(?!\/p\/)(?!\/gaoji\/)/,
      enabled: true,
      engineList: "web",
      style: '\
      display:block;\
      ...
      insertIntoDoc: {
        target: 'css;head',
        keyword: function () {
                    var input = document.querySelector(".formfont");//tn=baidulocal的搜索框
                    if (input) return input.value;
                    else input = document.getElementById('kw1');
                    if (input) return input.value;
                    else input = document.getElementById('kw');
                    if (input) return input.value;
                  },
                  where: 'afterEnd',
                },
              ...
              },
              {
                ...
                etc: function () {
                  setTimeout(function () { document.getElementsByTagName("section")[0].style.setProperty("top", "31px", "important"); }, 1500);
                }
              },
              {
                name: "picsearch",
              ...
              {
                name: "jpg4",
                url: /^http:\/\/img\.(jpger\.info\/|jpg4.net\/)/,
                engineList: "image",
                enabled: true,
                style: "\
                //margin-top:300px;\
              ...
              {
                name: "淘宝搜索",
                url: /^https?:\/\/(s|search8)\.taobao\.com\/search/,
                enabled: true,
                engineList: "shopping",
                style: "\
                margin-bottom:3px;\
              ...
              {
                name: "沪江英语",
                url: /^https?:\/\/dict\.hjenglish\.com\/(en|w|404)/,
                enabled: true,
                engineList: "translate",
                style: "\
                margin:0 auto;\
              ...
              var icons = {
                ...
                , kickass: 'data:image/png;base64,'
                ...
                , jpeg4: 'data:image/png;base64,'
                , twitter: 'data:image/png;base64,'
              ...
              /*网页搜索列表*/
              list.web = [];
              list.web[0] = ['Google', 'https://www.google.com.hk/search?q=%s&ie=utf-8&oe=utf-8', 'https://www.google.cn/favicon.ico']
              list.web[1] = ['百度', 'http://www.baidu.com/s?wd=%s&ie=utf-8', 'http://www.baidu.com/favicon.ico']
              list.web[2] = ['360', 'http://www.so.com/s?ie=utf-8&q=%s', 'http://www.so.com/favicon.ico']
              list.web[3] = ['bing', 'https://cn.bing.com/search?q=%s&pc=OPER', 'https://cn.bing.com/favicon.ico']
              list.web[7] = ['搜狗', 'http://www.sogou.com/web?query=%s', 'http://www.sogou.com/favicon.ico']
              /*百科搜索列表*/
              list.data = [];
              list.data[0] = ['ZWIKI', 'http://zh.wikipedia.org/w/index.php?search=%s&button=&title=Special%3ASearch', 'https://zh.wikipedia.org/favicon.ico']
              list.data[1] = ['EWIKI', 'http://en.wikipedia.org/w/index.php?search=%s&button=&title=Special%3ASearch', 'https://zh.wikipedia.org/favicon.ico']
              list.data[2] = ['JWIKI', 'http://ja.wikipedia.org/w/index.php?search=%s&button=&title=Special%3ASearch', 'https://zh.wikipedia.org/favicon.ico']
              list.data[3] = ['百科', 'http://baike.baidu.com/searchword/?word=%s&pic=1&sug=1&ie=utf-8', 'http://www.baidu.com/favicon.ico']
              list.data[-4] = ['互动', 'http://www.baike.com/wiki/%s&prd=button_doc_jinru', 'http://www.baike.com/favicon.ico']
              list.data[5] = ['Scholar', 'http://scholar.google.com/scholar?hl=zh-CN&q=%s&btnG=&lr=', 'http://scholar.google.com/favicon.ico']
              list.data[-6] = ['知道', 'http://zhidao.baidu.com/search?word=%s', 'http://www.baidu.com/favicon.ico']
              list.data[7] = ['知乎', 'http://www.zhihu.com/search?q=%s', 'http://www.zhihu.com/favicon.ico']
              list.data[-8] = ['文库', 'http://wenku.baidu.com/search?word=%s&ie=utf-8', 'http://www.baidu.com/favicon.ico']
              list.data[-9] = ['豆丁文档', 'http://www.docin.com/search.do?searchcat=2&searchType_banner=p&nkey=%s', 'http://www.docin.com/favicon.ico']
              list.data[11] = ['萌娘百科', 'http://zh.moegirl.org/index.php?search=%s', 'http://zh.moegirl.org/favicon.ico']
              /*视频搜索列表*/
              list.video = [];
              list.video[0] = ['soku', 'http://www.soku.com/v?keyword=%s', 'http://www.soku.com/favicon.ico']
              list.video[-1] = ['视频', 'http://v.baidu.com/v?word=%s&ie=utf-8', 'http://www.baidu.com/favicon.ico']
              list.video[-2] = ['360', 'http://video.so.com/mini.php?kw=%s', 'http://video.so.com/favicon.ico']
              list.video[3] = ['bilibili', 'http://www.bilibili.tv/search?keyword=%s', 'http://www.bilibili.com/favicon.ico']
              list.video[4] = ['acfun', 'http://www.acfun.tv/search.aspx#query=%s', 'http://www.acfun.tv/favicon.ico']
              list.video[5] = ['乐视', 'http://so.letv.com/s?wd=%s', 'http://www.letv.com/favicon.ico']
              list.video[6] = ['搜狐', 'http://so.tv.sohu.com/mts?wd=%s', 'http://tv.sohu.com/favicon.ico']
              ...
              list.video[9] = ['56', 'http://so.56.com/video/%s/?', 'http://www.56.com/favicon.ico']
              list.video[10] = ['ku6', 'http://so.ku6.com/search?q=%s&ie=utf-8&oe=utf-8', 'http://www.ku6.com/favicon.ico']
              list.video[11] = ['爱奇艺', 'http://so.iqiyi.com/so/q_%s', 'http://www.qiyipic.com/common/images/logo.ico']
              list.video[12] = ['腾讯', 'http://v.qq.com/search.html?&ms_key=%s', 'http://v.qq.com/favicon.ico']
              /*音乐搜索列表*/
              list.music = [];
              list.music[0] = ['天天动听', 'http://www.dongting.com/#a=searchlist&q=%s', 'http://www.dongting.com/favicon.ico']
              list.music[1] = ['Music', 'http://music.baidu.com/search?key=%s&ie=utf-8&oe=utf-8', 'http://www.baidu.com/favicon.ico']
              list.music[2] = ['QQ音乐', 'http://cgi.music.soso.com/fcgi-bin/m.q?w=%s&ie=utf-8&oe=utf-8', 'http://www.soso.com/favicon.ico']
              list.music[3] = ['搜狗', 'http://mp3.sogou.com/music.so?query=%s', 'http://www.sogou.com/favicon.ico']
              list.music[4] = ['一听', 'http://so.1ting.com/all.do?q=%s', 'http://www.1ting.com/favicon.ico']
              list.music[-5] = ['Songtaste', 'http://www.songtaste.com/search.php?keyword=%s', 'http://www.songtaste.com/favicon.ico', 'gbk']
              list.music[6] = ['虾米', 'http://www.xiami.com/search?key=%s', 'http://www.xiami.com/favicon.ico']
              list.music[7] = ['piapro', 'http://piapro.jp/search/?view=audio&keyword=%s', 'http://piapro.jp/favicon.ico']
              list.music[8] = ['Lyric', 'http://music.baidu.com/search/lrc?key=%s', 'http://www.baidu.com/favicon.ico']
              /*图片搜索列表*/
              list.image = [];
              list.image[0] = ['百度', 'http://image.baidu.com/i?ie=utf-8&word=%s', 'http://www.baidu.com/favicon.ico']
              list.image[1] = ['Google', 'https://www.google.com.hk/search?tbm=isch&q=%s', 'https://www.google.cn/favicon.ico']
              list.image[-2] = ['360', 'http://image.so.com/i?ie=utf-8&q=%s&src=tab_web', 'http://www.so.com/favicon.ico']
              list.image[-3] = ['bing', 'https://cn.bing.com/images/search?q=%s&pc=OPER', 'https://cn.bing.com/favicon.ico']
              list.image[4] = ['花瓣', 'http://huaban.com/search/?q=%s', 'http://huaban.com/favicon.ico']
              list.image[-5] = ['有道', 'http://image.youdao.com/search?q=%s', 'http://shared.ydstatic.com/images/favicon.ico']
              list.image[-6] = ['搜狗', 'http://pic.sogou.com/pics?query=%s', 'http://www.sogou.com/favicon.ico']
              list.image[7] = ['Picsearch', 'http://cn.picsearch.com/index.cgi?q=%s', 'http://www.picsearch.com/favicon.ico']
              ...
              list.image[10] = ['dA', 'http://www.deviantart.com/?q=%s', 'http://www.deviantart.com/favicon.ico', 'ASCII']
              list.image[11] = ['', 'http://img.jpg4.info/index.php?feed=%s', icons.jpeg4]
              /*下载列表*/
              list.download = [];
              list.download[0] = ['ktxp', 'http://bt.ktxp.com/search.php?keyword=%s', 'http://bt.ktxp.com/favicon.ico']
              list.download[1] = ['dmhy', 'http://share.dmhy.org/topics/list?keyword=%s', 'http://share.dmhy.org/favicon.ico']
              list.download[2] = ['nyaa', 'http://www.nyaa.se/?page=search&term=%s', 'http://files.nyaa.se/favicon.png']
              list.download[3] = ['kickass', 'https://kickass.to/usearch/%s/', icons.kickass]
              list.download[4] = ['bs', 'http://www.btspread.com/search/%s', 'http://www.btspread.com/app/btspread/View/images/favicon.ico']
              list.download[-5] = ['TK', 'http://www.torrentkitty.org/search/%s', 'http://www.torrentkitty.org/favicon.ico']
              list.download[6] = ['BTDigg', 'https://btdigg.org/search?q=%s', 'https://btdigg.org/favicon.ico']
              list.download[7] = ['ed2000', 'http://www.baidu.com/s?wd=%s+site:ed2000.com&ie=utf-8', 'http://www.ed2000.com/favicon.ico']
              /*购物列表*/
              list.shopping = [];
              list.shopping[0] = ['一淘', 'http://s.etao.com/search?q=%s', 'http://www.etao.com/favicon.ico']
              list.shopping[1] = ['京东', 'http://search.jd.com/Search?keyword=%s&enc=utf-8', 'http://www.jd.com/favicon.ico']
              list.shopping[2] = ['淘宝', 'http://s.taobao.com/search?q=%s', 'http://www.taobao.com/favicon.ico']
              list.shopping[-3] = ['天猫', 'http://list.tmall.com/search_product.htm?q=%s&type=p', 'http://www.tmall.com/favicon.ico', 'gbk']
              list.shopping[4] = ['亚马逊', 'http://www.amazon.cn/s/ref=nb_ss?keywords=%s', 'http://www.amazon.cn/favicon.ico']
              list.shopping[-5] = ['当当', 'http://search.dangdang.com/search.php?key=%s', 'http://www.dangdang.com/favicon.ico', 'gbk']
              list.shopping[-6] = ['QQ网购', 'http://se.wanggou.com/comm_search?KeyWord=%s', 'http://www.wanggou.com/favicon.ico', 'gbk']
              list.shopping[-7] = ['苏宁', 'http://search.suning.com/%s/', 'http://www.suning.com/favicon.ico']
              list.shopping[-8] = ['易迅', 'http://searchex.yixun.com/html?charset=utf-8&as=1&key=%s', 'http://www.yixun.com/favicon.ico']
              list.shopping[-9] = ['360购物', 'http://s.mall.360.cn/search.html?query=%s', 'http://www.so.com/favicon.ico']
              /*翻译列表*/
              list.translate = [];
              list.translate[0] = ['翻译', 'http://translate.google.com/translate_t?q=%s&oe=utf-8&ie=UTF-8', 'https://translate.google.cn/favicon.ico']
              list.translate[1] = ['百度译', 'http://fanyi.baidu.com/#auto2auto|%s', 'http://www.baidu.com/favicon.ico']
              list.translate[2] = ['翻译', 'http://fanyi.youdao.com/translate?i=%s', 'http://shared.ydstatic.com/images/favicon.ico']
              list.translate[3] = ['词典', 'http://dict.youdao.com/search?q=%s&ue=utf8', 'http://shared.ydstatic.com/images/favicon.ico']
              list.translate[-4] = ['翻译', 'http://www.bing.com/translator/?&text=%s&from=&to=zh-chs', 'https://cn.bing.com/favicon.ico']
              list.translate[5] = ['词典', 'http://www.bing.com/dict/search?q=%s&go=&qs=bs&form=CM', 'https://cn.bing.com/favicon.ico']
              list.translate[6] = ['ICIBA', 'http://www.iciba.com/%s/', 'http://www.iciba.com/favicon.ico']
              list.translate[7] = ['海词', 'http://dict.cn/%s', 'http://dict.cn/favicon.ico']
              list.translate[8] = ['沪江EN', 'http://dict.hjenglish.com/w/%s', 'http://dict.hjenglish.com/favicon.ico']
              list.translate[9] = ['中日', 'http://dict.hjenglish.com/jp/cj/%s', 'http://dict.hjenglish.com/jp/favicon.ico']
              list.translate[-10] = ['日中', 'http://dict.hjenglish.com/jp/jc/%s', 'http://dict.hjenglish.com/jp/favicon.ico']
              list.translate[11] = ['汉典', 'http://www.zdic.net/sousuo/?q=%s&tp=tp3', 'http://www.zdic.net/favicon.ico']
              /*其他*/
              list.sociality = [];
              list.sociality[0] = ['weibo', 'http://s.weibo.com/weibo/%s?topnav=1&wvr=5&b=1', 'http://weibo.com/favicon.ico']
              list.sociality[-1] = ['TX微博', 'http://search.t.qq.com/index.php?k=%s&pos=174&s_source=', 'http://t.qq.com/favicon.ico']
              list.sociality[2] = ['Tieba', 'http://tieba.baidu.com/f?kw=%s&ie=utf-8', 'http://www.baidu.com/favicon.ico']
              ...
              list.sociality[6] = ['豆瓣', 'http://www.douban.com/search?source=suggest&q=%s', 'http://www.douban.com/favicon.ico']
              list.etc = [];
              list.etc[0] = ['AMO', 'https://addons.mozilla.org/zh-CN/firefox/search/?q=%s', 'https://addons.cdn.mozilla.net/static/img/favicon.ico']
              list.etc[1] = ['射手字幕', 'http://shooter.cn/search/%s', 'http://shooter.cn/favicon.ico']
        /*控制列表的具体细节
        ...
        list.details[4] = ['音乐', 'music', list.music];
        list.details[5] = ['视频', 'video', list.video];
        list.details[6] = ['译&词典', 'translate', list.translate];
        list.details[8] = ['网购', 'shopping', list.shopping];
        list.details[-9] = ['社交', 'sociality', list.sociality];
        ...
        if (!matchedRule.insertIntoDoc) {
          if (prefs.debug)
            console.log("没找到insertIntoDoc 项");
          return;
        };
        ...
        if (!matchedInsertIntoDoc) {
          if (prefs.debug)
            console.log("matchedInsertIntoDoc不匹配");
          return;
        };
        ...
        container.className = 'sej_container';
              ...
              return {
                add: function (type, ele, callback) { //事件类型，元素，监听函数
                  if (support[type]) {
                    ...
                    DropDownListObj.zIndex = 99999999999;
        ...
        function insertIntoDocument(ele, target, where) {//加入到页面之中
          if (!where) {
            if (prefs.debug)
              console.log("InsertIntoDoc的 where 项,不存在");
            return;
          };
