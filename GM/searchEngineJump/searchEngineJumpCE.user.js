...
(function() {
	...
	var rules = [ //根据规则把搜索引擎列表插入到指定网站		
		...
		//影视
		{
			...
			name: "1337x",
			url: /^https?:\/\/www\.1337x\.(to|am)\/search/,
			engineList: "Movie",
		}, {
			name: "btdig",
			...
			engineList: "Movie",
			keyword: function() {
				var key = document.title.split('torrents/')[1];
				return key;
			},
		}, {
