		...
		},
		{
			...
			insertIntoDoc: {
				keyword: function () {
					...
					else return document.getElementById('firstHeading').children[1].textContent;
				},
				target: 'css;#siteNotice',
				where: 'beforeBegin'
			}
